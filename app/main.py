...
class AssistentTranscricao:
    ...
    def format_transcricao(self, infos, transcricao: str) -> str:
    ...
    def salve_file_transcricao(self, infos, infos_formated: str):
    ...
    def model_openai(self, model="gpt-4o-mini", temperature=0.1):
    ...
    def model_ollama(self, model="phi3", temperature=0.1):
    ...
    def get_video_info(self, url_video, language="pt", translation=None):
    ...
    def interpret_video(self, url, query="resuma", language="pt", translation=None):
        try:
            transcript, metadata = self.get_video_info(url, language, translation)
